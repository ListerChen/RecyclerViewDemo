...
public class MyItemAnimator extends SimpleItemAnimator {
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        final View view = holder.itemView;
        Log.e("TAGGG", "animateMoveImpl.getTop: " + view.getTop() + ", fromY: " + fromY + ", toY: " + toY);
    ...
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
                                 int fromX, int fromY, int toX, int toY) {
        Log.e("TAGGG", "animateChange  fromY: " + fromY + ", toY: " + toY);
        if (oldHolder == newHolder) {
            Log.e("TAGGG", "animateChange   oldHolder == newHolder");
